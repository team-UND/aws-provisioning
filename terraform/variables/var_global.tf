    ...
    ecr = {
      ...
      repository = {
        ...
        beforegoingsapne2 = {
          region = "ap-northeast-2"
          bucket = "teamund-apnortheast2-tfstate"
          key    = "aws-provisioning/terraform/ecr/teamund/beforegoings_apnortheast2/terraform.tfstate"
        }
    ...
    lambda = {
      ...
      function = {
        ...
        beforegoingsapne2 = {
          region = "ap-northeast-2"
          bucket = "teamund-apnortheast2-tfstate"
          key    = "aws-provisioning/terraform/lambda/teamund/beforegoings_apnortheast2/terraform.tfstate"
        }
    ...
    apigw = {
      ...
      http = {
        ...
        beforegoingsapne2 = {
          region = "ap-northeast-2"
          bucket = "teamund-apnortheast2-tfstate"
          key    = "aws-provisioning/terraform/apigw/teamund/beforegoings_apnortheast2/terraform.tfstate"
        }
